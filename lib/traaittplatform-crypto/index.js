...
/**
 * Module of traaittPlatform Cryptographic Methods
 * @module Crypto
 * @class
 */
class Crypto {
...
function loadBrowserWASM () {
  ...
  try {
    const Self = window.traaittPlatformCrypto()
...
function loadNativeAddon () {
  try {
    const Self = require('traaittplatform-crypto')
...
function loadNativeJS () {
  try {
    const Self = require('./traaittplatform-crypto.js')()
...
function loadWASMJS () {
  ...
  try {
    const Self = require('./traaittplatform-crypto-wasm.js')()
