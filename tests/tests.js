...
const traaittPlatformUtils = require('../').CryptoNote
const cnUtil = new traaittPlatformUtils(require('../config.json'))

console.log('Using Crypto: %s', traaittPlatformCrypto.type)

describe('Cryptography', () => {
  it('Generate Random Keys', () => {
    const [err, keys] = traaittPlatformCrypto.generateKeys()
  ...
  it('Check Key - Public Key', () => {
    ...
    const isValid = traaittPlatformCrypto.checkKey(key)
  ...
  it('Tree Hash', () => {
    ...
    const [err, treeHash] = traaittPlatformCrypto.tree_hash([
  ...
  it('Tree Branch', () => {
    ...
    const [err, treeBranch] = traaittPlatformCrypto.tree_branch([
      'b542df5b6e7f5f05275c98e7345884e2ac726aeeb07e03e44e0389eb86cd05f0',
      '1b606a3f4a07d6489a1bcd07697bd16696b61c8ae982f61a90160f4e52828a7f',
      'c9fae8425d8688dc236bcdbc42fdb42d376c6ec190501aa84b04a4b4cf1ee122',
      '871fcd6823f6a879bb3f33951c8e8e891d4043880b02dfa1bb3be498b50e7578'
  ...
  algos.forEach((algo) => {
    it(algo.name, () => {
      const [err, hash] = traaittPlatformCrypto[algo.func](testdata)
